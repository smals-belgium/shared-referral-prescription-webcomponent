...
import { PrescriptionDetailsBeneficiaryComponent } from '../beneficiary/prescription-details-beneficiary.component';
...
describe('PrescriptionDetailsMainComponent', () => {
  ...
  describe('populate infoElements', () => {
    it('populates infoElements only with viewType info and resets infoElements on each new prescription load', () => {
      const elements = [
