...
- wc-prescription-list: ./dist/build/wc-prescription-list.js and ./dist/build/wc-prescription-list.js
...
# Push to github
Run npm i and past the content to package-lock.github.json
