(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define('keycloak-authorization', factory)
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
        (global.KeycloakAuthorization = factory()));
})(this, function () {
  'use strict';
  ...
  var KeycloakAuthorization = function (keycloak, options) {
    ...
    if (
      typeof es6Promise_minExports.Promise !== 'undefined' &&
      es6Promise_minExports.Promise.toString().indexOf('[native code]') !== -1
    ) {
