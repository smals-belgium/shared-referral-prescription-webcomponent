...
- Respond reasonably to improvement requests from Smals or its sponsoring members.
...
4. **Supervision**
   Smals, together with the sponsoring members, reserves the right to review, accept, reject, or request modifications to any contribution.

5. **Acceptance**
   By downloading, integrating, or contributing to the Code, the Integrator accepts this License.

6. **Trademarks**
   This License does not grant rights to use Smals’ or the Sponsors’ names, trademarks, or logos.
