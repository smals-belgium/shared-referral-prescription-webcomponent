...
export const APP_CONFIG: AppConfig = {
  ...
  variables: {
    localPatient: {
      env: "localPatient",
      fhirGatewayUrl:
        "http://referral-prescription-fakeapi-v4.test.paas.vasdc.be",
    ...
    testHcp: {
      env: "testHcp",
      fhirGatewayUrl:
        "https://referral-prescription-v4.test.ext.vascloud.be/backend/application/fhirgateway/uhmep/v1",
    ...
    accHcp: {
      ...
      fhirGatewayClientId: "nihdi-uhmep-fhir-hcp",
      apiUrl:
        "https://wwwacc.referral-prescription.ehealth.fgov.be/frontend/api",
      pseudoApiUrl: "https://api-acpt.ehealth.fgov.be/pseudo/v1",
      enablePseudo: true,
    },
    accPatient: {
    ...
    accInHcp: {
      ...
      fhirGatewayClientId: "nihdi-uhmep-fhir-hcp",
      apiUrl:
        "https://wwwacc.referral-prescription.in.ehealth.fgov.be/frontend/api",
      pseudoApiUrl: "https://api-acpt.ehealth.fgov.be/pseudo/v1",
      enablePseudo: true,
    },
    accInPatient: {
    ...
    accUpHcp: {
      ...
      fhirGatewayClientId: "nihdi-uhmep-fhir-hcp",
      apiUrl:
        "https://wwwacc.referral-prescription.up.ehealth.fgov.be/frontend/api",
      pseudoApiUrl: "https://api-acpt.ehealth.fgov.be/pseudo/v1",
      enablePseudo: true,
    },
    accUpPatient: {
    ...
    prodInHcp: {
      ...
      fhirGatewayClientId: "nihdi-uhmep-fhir-hcp",
      apiUrl:
        "https://www.referral-prescription.in.ehealth.fgov.be/frontend/api",
      pseudoApiUrl: "https://api.ehealth.fgov.be/pseudo/v1",
      enablePseudo: true,
    },
    prodInPatient: {
    ...
    prodUpHcp: {
      ...
      fhirGatewayClientId: "nihdi-uhmep-fhir-hcp",
      apiUrl:
        "https://www.referral-prescription.up.ehealth.fgov.be/frontend/api",
      pseudoApiUrl: "https://api.ehealth.fgov.be/pseudo/v1",
      enablePseudo: true,
    },
    prodUpPatient: {
