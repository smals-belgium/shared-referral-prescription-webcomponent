...
describe('ExternalSourceService', () => {
  ...
  let pssService: jest.Mocked<PssService>;
  ...
  beforeEach(() => {
    ...
    pssService = TestBed.inject(PssService) as jest.Mocked<PssService>;
  });

  it('should throw error when value is "failed"', (done) => {
  ...
  it('should return valid result', (done) => {
    const externalSource: ExternalSource = {dataUrl: 'test-url'};
