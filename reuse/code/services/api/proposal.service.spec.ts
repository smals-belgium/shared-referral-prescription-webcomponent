...
describe('ProposalService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [ProposalService, { provide: ApiProposalService, useValue: apiProposalServiceMock }],
    });
  ...
  describe('create', () => {
    it('should call api.createProposal with correct parameters', () => {
      ...
      expect(apiProposalServiceMock.createProposal).toHaveBeenCalledWith(generatedUUID, mockRequestResource);
  ...
  describe('transferAssignation', () => {
    it('should call api.transferAssignationToProposal with correct parameters', () => {
      ...
      service.transferAssignation(prescriptionId, referralTaskId, performerTaskId, caregiver, generatedUUID);
  ...
  describe('approveProposal', () => {
    it('should call api.approveProposal with correct parameters', () => {
      ...
      expect(apiProposalServiceMock.approveProposal).toHaveBeenCalledWith(proposalId, generatedUUID, reason);
    });
  });
  ...
  describe('cancelProposal', () => {
    it('should call api.cancelProposal with correct parameters', () => {
      ...
      service.cancelProposal(proposalId, reason, generatedUUID);

      expect(apiProposalServiceMock.cancelProposal).toHaveBeenCalledWith(proposalId, generatedUUID, reason);
    });
  });
  ...
  describe('rejectProposal', () => {
    it('should call api.rejectProposal with correct parameters', () => {
      ...
      expect(apiProposalServiceMock.rejectProposal).toHaveBeenCalledWith(proposalId, generatedUUID, reason);
    });
  });
});
